...
class ObjectJDBCDAOTest {
    ...
    private Object obj1;
    private Object obj2;
    private ObjectJDBCDAO dao;
    @org.junit.jupiter.api.BeforeEach
    void befEach() throws SQLException {
        dao = new ObjectJDBCDAO(DriverManager.getConnection(url, un, ps));
        obj1 = dao.create(new Object(1, "1"));
        obj2 = dao.create(new Object(2, "2"));
    }
    ...
    void create() throws SQLException {
        Object type3 = dao.create(new Object(4,"3"));
